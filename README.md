...
- `git clone https://github.com/javalopes/Petcoin`
- `cd Petcoin`
- `mkdir build && cd $_`
- `cmake ..`
- `make`
...
Run `./src/PetCoind` to connect to the network and let it sync (it may take a while).
